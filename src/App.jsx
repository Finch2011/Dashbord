  ...
  return (
    ...
    <div className="profile-container">
        <div className="profile-header">
            <img src="./public/thumb-1920-169164.jpg" alt="Profile Picture" className="profile-pic"/>
        ...
        <div className="profile-skills">
            ...
            <ul>
              ...
              <li onClick={LogOut} className='Logout'>Logout <img src="./public/Logout.svg" alt="" /></li>
            </ul>
        </div>
    </div>
      </div>
